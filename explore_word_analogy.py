...
def read_write_format(input_dir, output_dir, evaluation_file, similarity_type):
    ...
    with open('{0}/{1}'.format(output_dir, evaluation_file), 'w') as eval_file:
